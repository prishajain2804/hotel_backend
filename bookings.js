...
const COLLECTION_BOOKING = "bookings";
...
router.post("/", async function (req, res) {
  let dbo = await client.db(DB_NAME);
  var myobj = req.body;
  let data = await dbo.collection(COLLECTION_BOOKING).insertOne(myobj);
  console.log(data);
...
router.delete("/:id", async function (req, res) {
  ...
  let data = await  dbo.collection(COLLECTION_BOOKING).deleteOne(query);
